const imagenes = document.querySelectorAll('#minis img')
const hero= document.querySelector('#hero img');

for (const imagen of imagenes) {
    /*click en imagen recorrida en el nodelist imagenes y
     cambio por la nueva */
    imagen.addEventListener('click', ()=>
    cambioImagen(hero, imagen) );
}
function cambioImagen(heroImagen, nuevaImagen){
    heroImagen.src=nuevaImagen.src;
}
